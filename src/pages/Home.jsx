...
import doctor01 from '../assets/images/doctor01.png';
import doctor02 from '../assets/images/doctor02.png';
import doctor03 from '../assets/images/doctor03.png';
  ...
  return (
        ...
        <div className="container">
          <div className='flex flex-col lg:flex-row gap-[90px] items-center justify-between'>
            ...
            <div>
              <div className='lg:w-[570px]'>
                ...
                <p className='text_para'>
                  ...
                  exam yourself and take blood Tests frequently,
                  we care about you, So don't hesitate taking an appointment! 
                </p>
            ...
            <div className='flex gap-[30px] justify-end'>
              <img src={doctor01} alt="" />
            </div>
            <div className="mt-[30px]">
              <img src={doctor02} alt="" className='w-full mb-[30px]'/>
              <img src={doctor03} alt="" className='w-full'/>
            </div>
          </div>
        </div>
      </section>
    ...
    <section>
      ...
      <div className='xl:w-[470px] mx-auto'>
        <h2 className="heading text-center">Our Medical Servies</h2>
        <p className='text__para text-center'>
          world class care for everyone, Our health System offers unmatched,
          expert health care.
        </p>
          ...
          <div className='container'>
            <div className='flex items-center justify-between flex-col lg:flex-row'>
                ...
                <div className='relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0'>
                  ...
                  <div className='w-[150px] lg:w-[248px] bg-white absolute bottom-[50px] left_0 
