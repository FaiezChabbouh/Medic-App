...
import avatar from "../assets/images/doctorblack01.png";
          ...
          <div className='rounded-l-lg lg:pl-16 py-10'>
            ...
            <form onSubmit={submitHandler}>
              ...
              <div className='mb-5 flex items-center justify-between'>
                ...
                <label htmlFor="gender" className='text-headingColor font-bold text-[17px] leading-7'>
                  Gender:
                  <select name="gender"
              ...
              <p className="mt-5 text-textColor text-center">
                Already have an account? <Link to="/register" className="text-primaryColor font-medium ml-1">Login</Link>
              </p>
